...
use windows::Win32::UI::WindowsAndMessaging::{
    ...
    GetWindowTextW, IsDialogMessageW, IsWindow, IsWindowVisible, KillTimer, LoadCursorW,
    RegisterClassW, SetCursor, SetForegroundWindow, SetTimer, SetWindowLongPtrW, SetWindowPos,
    ShowWindow, TrackPopupMenu, BS_DEFPUSHBUTTON, BS_PUSHBUTTON, CS_DBLCLKS, ES_AUTOHSCROLL,
    GWL_HWNDPARENT, HICON, HMENU, HTCLIENT, IDC_ARROW, IDC_SIZENESW, IDC_SIZENS, IDC_SIZENWSE,
    IDC_SIZEWE, IDC_SIZEALL, MF_CHECKED, MF_POPUP, MF_SEPARATOR,
    MF_STRING, MSG, SC_MINIMIZE, SM_CXDRAG, SM_CYDRAG, SET_WINDOW_POS_FLAGS, SWP_HIDEWINDOW,
    SWP_NOACTIVATE, SWP_NOSIZE, SWP_NOZORDER, SW_SHOW, SW_SHOWNA, SW_SHOWNORMAL, DI_NORMAL,
    TPM_NONOTIFY, TPM_RETURNCMD, TranslateMessage, ULW_ALPHA, UpdateLayeredWindow, WINDOWPOS,
    WINDOW_STYLE, WNDCLASSW, WM_APP, WM_CLOSE, WM_COMMAND, WM_DESTROY, WM_ERASEBKGND,
    WM_LBUTTONDBLCLK, WM_LBUTTONDOWN, WM_LBUTTONUP, WM_MOUSEMOVE, WM_MOUSEWHEEL, WM_NCHITTEST,
    WM_PAINT, WM_RBUTTONUP, WM_SETCURSOR, WM_SHOWWINDOW, WM_SYSCOMMAND, WM_TIMER,
    WM_DISPLAYCHANGE, WM_DPICHANGED, WM_WINDOWPOSCHANGING,
